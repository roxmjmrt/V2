...
import { MARMOT } from './tokens'

// BNB
export const DEFAULT_INPUT_CURRENCY = 'BNB'
// MARMOT
export const DEFAULT_OUTPUT_CURRENCY = MARMOT[ChainId.BSC].address
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC]: [bscTokens.wbnb, MARMOT[ChainId.BSC], bscTokens.usdt],
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.BSC]: [
    [bscTokens.wbnb, MARMOT[ChainId.BSC]],
    [MARMOT[ChainId.BSC], bscTokens.usdt],
...
export const PRICE_IMPACT_WITHOUT_FEE_CONFIRM_MIN: Percent = new Percent(500n, BIPS_BASE) // 5%
// for non expert mode disable swaps above this
export const BLOCKED_PRICE_IMPACT_NON_EXPERT: Percent = new Percent(500n, BIPS_BASE) // 5%
