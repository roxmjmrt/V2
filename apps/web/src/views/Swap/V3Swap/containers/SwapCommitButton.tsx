...
import { AutoColumn, Box, Button, Dots, Message, MessageText, Text, useModal, Flex, Toggle, Image } from '@pancakeswap/uikit'
  ...
  return (
    <Box mt="0.25rem">
      <CommitButton
        ...
        variant={isValid && !errorMessage ? 'primary' : 'danger'} 
        disabled={disabled}
        onClick={handleSwap}
      >
        {swapInputError ||
      ...
      {/* MEV Protection Message */}
      <Box mt="8px" p="12px" background="backgroundAlt2" borderRadius="default">
        <Flex alignItems="center" justifyContent="space-between">
          <Flex alignItems="center">
            <Box width="20px" height="20px" mr="8px">
              <img src="/images/swap/shield.svg" alt="MEV Shield" width="20" height="20" />
            </Box>
            <Text>{t('MEV Guard protects you from frontrunning and sandwich attacks when Swapping.')}</Text>
          </Flex>
          <Toggle 
            id="mev-protect-toggle"
            scale="sm"
            checked={true}
            onChange={() => {}}
          />
